...
namespace LocationToVisibilityConverter
{
    public partial class MainWindow : Window
    {
        ...
        private void Item_Quellen_Click(object sender, RoutedEventArgs e)
        {
            Quellen quellen = new Quellen();
            quellen.Owner = Application.Current.MainWindow;
            quellen.Show();
        }

        private void Item_Über_Click(object sender, RoutedEventArgs e)
        {
            Über über = new Über();
            über.Owner = Application.Current.MainWindow;
            über.Show();
        }
        ...
        private void Suchbar_TextChanged(object sender, System.Windows.Controls.TextChangedEventArgs e)
        {
